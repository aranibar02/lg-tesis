...
var gymName = params[1];
var serviceUrl = '';
var option = ''

if(params.length > 1){
  option = 'Reservar';
  serviceUrl = `https://ires2-tesis-backend.herokuapp.com/api/v1/gyms?name=${gymName}`;
}else{
  serviceUrl = `https://ires2-tesis-backend.herokuapp.com/api/v1/gyms`;
