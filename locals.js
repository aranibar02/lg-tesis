...
var localName = params[1];
var serviceUrl = '';
if(params.length > 1){
  serviceUrl = `https://ires2-tesis-backend.herokuapp.com/api/v1/locals?name=${localName}`;
  action = 'Reservar';
}else{
  serviceUrl = `https://ires2-tesis-backend.herokuapp.com/api/v1/locals`;
